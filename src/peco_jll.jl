...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import peco_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("b89f85f3-45f8-5ea8-8223-9dfa39faf294"))
platforms = [Pkg.Artifacts.unpack_platform(e, "peco", artifacts_toml) for e in artifacts["peco"]]
...
if best_platform === nothing
    @debug("Unable to load peco; unsupported platform $(triplet(platform_key_abi()))")
else
